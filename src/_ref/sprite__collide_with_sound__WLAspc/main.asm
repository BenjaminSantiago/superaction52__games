...
spc_program:
    .incbin "audio/bin/spc__playWithCollide.bin"
    .incbin "audio/samples/guitar_palmmuted__C__32k.BRR"
    .incbin "audio/samples/hihat__32k.brr"
    .incbin "audio/samples/kick__32k.brr"
    .incbin "audio/samples/snare__32k.brr"
spcend:
        .db $FF
;---------------------------------------------------------------
.ENDS
